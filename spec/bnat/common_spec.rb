...
module BNAT
  describe Common do
    ...
    context "when generating a packet with #get_tcp_packet" do
      it "should generate a TCP packet" do
        @helper.get_tcp_packet.should be_kind_of(PacketFu::TCPPacket)
      end
    end

    context "when converting a packet to a hash" do
      it "should convert a TCP packet into a hash" do
        packet = @helper.get_tcp_packet
        @helper.packet_to_hash(packet).should be_kind_of(::Hash)
      end
    end
