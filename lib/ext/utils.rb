# MONKEY PATCH
#
# I'm applying this monkey patch to ensure that BNAT
# properly handles interface lookups until this pull
# request is accepted in PacketFu and the gem is rev'd
#
# https://github.com/todb/packetfu/pull/43
#
# This patch can be removed when the above conditions
# are met
